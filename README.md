...
ConditionCommandEffectCaught ≥ 3 times & distance < 1.5Arena ExpandedNext level size +5 unitsCaught ≥ 2 times & distance < 2.0Enemy SlowedEnemy speed × 0.5Never caught & chase ratio < 0.3Enemy AcceleratedEnemy speed × 1.5
